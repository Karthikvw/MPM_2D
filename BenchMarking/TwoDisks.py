...
Disk_1 = MPM_2D.MPM_STVKSolid(Emod, Density, Poisson, MPV_1)
Disk_1.MPC()[:,2] = 0.1; Disk_1.MPC()[:,3] = 0.1

Disk_2 = MPM_2D.MPM_STVKSolid(Emod, Density, Poisson, MPV_2)
...
for step in trange (noMacroSteps):
    TwodisksSolver.Solve(Grid, Bodies, noMicroSteps, dt, alpha)
